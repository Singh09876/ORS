...
<body > <center style="color:red;display: flex;justify-content: center; ">
	         <h1><b><img src= "<%=ORSView.APP_CONTEXT %>/img/OIP2.jpeg"  width="26" height="22"><font style="border-bottom-style:padding-left;" >R</font></b><code style="color:black;">AYS</code></h1></center>
	<%
